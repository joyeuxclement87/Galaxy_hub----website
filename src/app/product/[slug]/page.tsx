         ...
         <div className="mx-auto max-w-[1320px] px-4 sm:px-6 md:px-8 pt-4 lg:pt-6">
           <div className="grid grid-cols-1 gap-6 md:gap-8 lg:gap-14 lg:grid-cols-2">
             ...
             <div className="flex flex-col">
               ...
               <h1 className="mt-2 font-display text-lg sm:text-xl lg:text-2xl font-bold leading-[1.15] tracking-tight text-ocean-deeper">
                 {product.name}
               </h1>
               ...
               <div className="mt-4 flex flex-wrap items-baseline gap-x-3 gap-y-1">
                 <span className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-ocean-deeper leading-none">
