      ...
      <div className="relative mx-auto max-w-[1320px]">
        ...
        <div className="mt-8 flex flex-col gap-3 rounded-card border border-ocean/10 bg-white/80 backdrop-blur-sm p-5 sm:flex-row sm:items-center sm:justify-between shadow-sm">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/order"
              className="inline-flex items-center justify-center rounded-btn bg-ocean-deeper px-7 h-11 text-sm font-bold text-white shadow-btn transition-all duration-250 hover:bg-ocean-dark hover:shadow-btn-hover hover:-translate-y-0.5"
            >
              Order Now
            </Link>
            <a
