            ...
            {product.priceOnRequest ? (
              ...
              <div>
                <div className="flex items-end gap-3">
                  ...
                  {product.badge && <div className="ml-auto rounded-full bg-rose-50 text-rose-600 px-2.5 py-0.5 text-[10px] font-bold lowercase tracking-[0.08em] border border-rose-100/60">{product.badge.toLowerCase() === "on sale" ? "on sale" : product.badge.toLowerCase()}</div>}
                </div>
